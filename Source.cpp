...
void Admin() {
   ...
   cout << "Phim bat ki: Quay ve trang chu" << std::flush << endl;
   cin >> n; cin.ignore();
   fflush(stdin);
   if ((n == 1) || (n == 2) || (n == 3)) {
       if (n == 1) {
...
void Acc(string user, string ten_dang_nhap) {
   ...
   int line_book;
   int numberofbook;
   std::string user_num_book;
   std::string user_ID_book;
   std::ifstream input_book("Book_List.txt");
   std::ifstream input_ID("ID.txt");
   std::ifstream input_Number_Book("Number_Book.txt");
   input_Number_Book >> numberofbook;
   user = user + ".txt";
   user_num_book = "num_book_" + tdn;
   user_ID_book = "ID_book_" + tdn;
   std::cout << "Xin chao ban " << tdn;
   std::cout << " cua tui" << std::endl;
   std::cout << "Ban muon lam gi the ?" << std::endl;
   std::cout << "1. Muon sach" << std::endl;
   std::cout << "2. Tra sach" << std::endl;
   std::cout << "3. Thoat ve trang chu" << std::endl;
   ...
   if (n == 1) {
       if ((input_ID.is_open()) && (input_book.is_open())) {
           ...
           while (std::getline(input_ID, outfile1) && std::getline(input_book, outfile2)) {
               std::cout << outfile1 << outfile2 << endl;
           }
           input_ID.close();
           input_book.close();
       }
       ...
       while (std::getline(read_file, line))
           lines.push_back(line);
       read_file.close();
       std::cout << "Ban muon muon sach co ID nao?" << endl;
       cin >> line_book; cin.ignore();
       line_book = line_book + 1;
       if (line_book-1 > numberofbook) {
           std::cout << "Sach co ID " << line_book-1;
           std::cout << " khong co trong thu vien" << std::endl;
           std::cout << "Thu vien chi co " << numberofbook;
           std::cout << " sach" << std::endl;
       }
       else {
           std::ifstream inputnum(user_num_book);
           int num;
           inputnum >> num;
           inputnum.close();
           if (num == -858993460) {
           ...
           std::ofstream input_user(user, ios::app);
           std::ofstream input_user_ID(user_ID_book, ios::app);
           std::ofstream input_user_num_book(user_num_book);
           line_book--;
           for (int i = 0; i < lines.size(); i++)
               if (i == line_book)
           ...
           std::cout << "Muon thanh cong !" << std::endl;
           system("pause");
           alo();
       }
   }
   if (n == 2) {
       ...
       while (std::getline(read_file, line))
           lines.push_back(line);
       read_file.close();
       std::ifstream input1(user_ID_book);
       std::ifstream input2(user);
       std::ifstream input3(user_num_book);
       input3 >> numbook;
       input3.close();
       int n;
       cout << "ID                  Tac Gia			  Tac Pham				  So Trang	      Nam xuat ban" << std::endl;
       ...
       std::cout <<"Ban muon tra sach co ID " << std::endl;
       cin >> n; cin.ignore();
       ofstream write_file;
...
void Display() {
   system("CLS");
   std::ifstream inputabc("Display.txt");
   if (inputabc.is_open()) {
       std::string outfile1;
...
void Start() {
   int nhap;
   std::cout << "0. Restart " << std::endl;
   std::cout << "1. Dang nhap " << std::endl;
   std::cout << "2. Dang ki " << std::endl;
...
void Dang_nhap() {
   ...
   std::cout << "Nhap ten nguoi dung "  << std::endl;
   std::getline(std::cin, ten_dang_nhap);
...
//};
//void Dang_nhap() {
//    ifstream inputabc("Display.txt");
//    if (inputabc.is_open()) {
//        string outfile1;
//        while (getline(inputabc, outfile1)) {
//            cout << outfile1 << endl;
//        }
//        inputabc.close();
//    }
